...
COLUMNS_TO_KEEP = ["block_number", "receipt_gas_used", "transaction_index", "gas_price"]
...
if __name__ == "__main__":
    ...
    # Get user input for input and output folder paths
    input_folder = input("Enter the Input Folder full path: ").strip()
    output_folder = input("Enter the Output Folder full path: ").strip()
